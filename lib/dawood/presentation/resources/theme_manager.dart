...
ThemeData getApplicationTheme() {
  return ThemeData(
      ...
      colorScheme:
          ColorScheme.fromSwatch().copyWith(secondary: ColorManager.error),
      ...
      cardTheme: CardTheme(
          ...
          shape: RoundedRectangleBorder(
              ...
              side: BorderSide(
                  color: ColorManager.pinkPrimary, width: AppSize.s2))),
      //************************CardView theme*****End*********************

      //************************textFormField decoration*****************************
      inputDecorationTheme: InputDecorationTheme(
        contentPadding: EdgeInsets.all(AppPadding.p8),
        hintStyle: getPopRegularStyle(
        ...
        focusedBorder: OutlineInputBorder(
          borderSide:
              BorderSide(color: ColorManager.pinkPrimary, width: AppSize.s2),
          borderRadius: BorderRadius.circular(AppSize.s14),
        ),
      ...
      appBarTheme: AppBarTheme(
          ...
          titleTextStyle: getSfRoundedHeavyStyle(
      ...
      //************************Text theme*****************************
      textTheme: TextTheme(
          displayLarge: getSfRoundedHeavyStyle(
              color: ColorManager.bluePrimary, fontSize: FontSize.s32),
          displayMedium: getSfRoundedBold(
              color: ColorManager.pinkPrimary, fontSize: FontSize.s28),
          displaySmall: getSfRoundedBold(
              color: ColorManager.bluePrimary, fontSize: FontSize.s16),
          titleMedium: getQuestrialRegularStyle(
              color: ColorManager.pinkPrimary, fontSize: FontSize.s20),
          titleLarge: getSfTextSemiBoldStyle(
              color: ColorManager.white, fontSize: FontSize.s16),
          bodySmall: getQuestrialRegularStyle(
              color: ColorManager.white, fontSize: FontSize.s12),
          bodyLarge: getSfTextMediumStyle(
              color: ColorManager.pinkPrimary, fontSize: FontSize.s18),
          bodyMedium: getQuestrialRegularStyle(
              color: ColorManager.black, fontSize: FontSize.s16)),
      //************************Text theme***End***********************

      tabBarTheme: TabBarTheme(
          unselectedLabelColor: ColorManager.bluePrimary,
          unselectedLabelStyle: getSfRoundedBold(color: ColorManager.bluePrimary, fontSize: FontSize.s16),
          indicatorColor: ColorManager.pinkPrimary,
          labelColor: ColorManager.pinkPrimary,
          labelStyle: getSfRoundedBold(color: ColorManager.pinkPrimary, fontSize: FontSize.s16),
          indicatorSize: TabBarIndicatorSize.tab,
          indicator: UnderlineTabIndicator(
            borderSide: BorderSide(
              color: ColorManager.pinkPrimary,
              width: AppSize.s2, // Thickness of the underline
            ),
