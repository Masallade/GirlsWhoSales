...
class Requests {
  ...
  static Future<dynamic> Login(BuildContext context, String userName, String password, String token1 ,bool resync) async {
            ...
            MaterialPageRoute(
              builder: (context) {
                return HomePage(
                  ...
                  title:loginModel.seekerDetails[0].jobTitle, total_applied: loginModel.countOfJobsApplied,
    ...
    catch(error)
    {
      ...
      utils().showDialogCustomForLogin(context, "Failed", "Provided email or password is invalid.", "OK");
    }
  }
